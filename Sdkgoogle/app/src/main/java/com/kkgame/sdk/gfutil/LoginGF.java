...
//        String base64EncodedPublicKey = mactivity.getString(R.string.base64EncodedPublicKey);
...
//        String SKU_GAS = getWaresid(YYWMain.mOrder.goods);
        paycode = SKU_GAS;
...
//        }
    ...
    public static void login_http(final Activity mactivity,String uid,String username){
