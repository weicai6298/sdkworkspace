...
//	        PluginCenter pCenter = PluginCenter.getInstance(paramActivity);
//	        pCenter.pay(paramActivity, "10", "1", Float.parseFloat(order.money/100+""), order.goods, "10", "100", "123456789", "", new PPayListener() {
//				
//				@Override
...
//						    } else {
////						    	payFail();
////						    Toast("支付失败=> " + Utils.checkEmpty(msg));
//						    }
//				}
//				
//				@Override
