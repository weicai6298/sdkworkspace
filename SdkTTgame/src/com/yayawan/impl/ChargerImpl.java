...
public class ChargerImpl implements YYWCharger {
	...
	public void createOrder(final Activity paramActivity) {
		...
		requestParams.addBodyParameter("ttuid", YaYawanconstants.uid);
		requestParams.addBodyParameter("subject", YYWMain.mOrder.goods);
					...
					public void onSuccess(ResponseInfo<String> arg0) {
						...
						try {
							...
							if (err_code == 0) {
								...
								paytoken = data.optString("paytoken");
	...
	private void pay_run(final Activity paramActivity) {
		...
		YaYawanconstants.pay(paramActivity, orderId , paytoken);
