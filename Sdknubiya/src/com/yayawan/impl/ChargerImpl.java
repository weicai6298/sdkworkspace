...
public class ChargerImpl implements YYWCharger {
	...
	public void createOrder(final Activity paramActivity) {
		...
		requestParams.addBodyParameter("nby_uid", GameSdk.getLoginUid());
		requestParams.addBodyParameter("nby_game_id", GameSdk.getLoginGameId());
					...
					public void onSuccess(ResponseInfo<String> arg0) {
						...
						try {
							...
							if (err_code == 0) {
								...
								JSONObject data1 = obj.getJSONObject("params");
								data_timestamp = data1.optString("data_timestamp");
								amount = data1.optString("amount");
	...
	private void pay_run(final Activity paramActivity) {
		...
		YaYawanconstants.pay(paramActivity, orderId, sign ,data_timestamp ,amount);
