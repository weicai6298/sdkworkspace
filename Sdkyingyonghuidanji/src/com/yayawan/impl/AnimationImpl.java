...
//				mCpInfo.orientation = DeviceUtil.isLandscape(paramActivity)?CPInfo.LANDSCAPE:CPInfo.PORTRAIT;
				YYHSDKAPI.startSplash(paramActivity, DeviceUtil.isLandscape(paramActivity)?CPInfo.LANDSCAPE:CPInfo.PORTRAIT, 3000);
			}
		});
