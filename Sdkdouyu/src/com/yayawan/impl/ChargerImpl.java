...
public class ChargerImpl implements YYWCharger {
	...
	public void createOrder(final Activity paramActivity) {
		...
		requestParams.addBodyParameter("role_name", YaYawanconstants.role_Id);
		requestParams.addBodyParameter("area_id", YaYawanconstants.zone_Id);
		...
		Yayalog.loger("goods:"+ YYWMain.mOrder.goods);
		Yayalog.loger("role_name:"+ YaYawanconstants.role_Id);
		Yayalog.loger("area_id:"+ YaYawanconstants.zone_Id);
					...
					public void onSuccess(ResponseInfo<String> arg0) {
						...
						try {
							...
							if (err_code == 0) {
								...
								payinfo = data.optString("payinfo");
	...
	private void pay_run(final Activity paramActivity) throws JSONException {

		YaYawanconstants.pay(paramActivity, orderId,payinfo);
