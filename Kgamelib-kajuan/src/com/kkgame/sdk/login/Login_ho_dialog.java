...
public class Login_ho_dialog extends Basedialogview {
	...
	public void createDialog(final Activity mActivity) {
		...
		//9dm登录
//		bt_9dmlogin = new Button(mActivity);
//		bt_9dmlogin = machineFactory.MachineButton(bt_9dmlogin, 0, MATCH_PARENT, 1,
//				"9dm登录", 30, mLinearLayout, 0, 0, 0, 0);
//		bt_9dmlogin.setTextColor(Color.WHITE);
//		bt_9dmlogin.setBackgroundDrawable(GetAssetsutils.crSelectordraw(
//				"yaya_yellowbutton.9.png", "yaya_yellowbutton1.9.png",
//				mActivity));
//		bt_9dmlogin.setGravity(Gravity_CENTER);

		// TODO
		ll_mBut.addView(bt_mPhonelogin);
		ll_mBut.addView(ll_zhanwei);
		ll_mBut.addView(bt_mlogin);
//		ll_mBut.addView(bt_9dmlogin);
