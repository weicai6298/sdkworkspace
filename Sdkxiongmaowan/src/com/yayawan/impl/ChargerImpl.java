...
public class ChargerImpl implements YYWCharger {
	...
	public void createOrder(final Activity paramActivity) {
		...
		requestParams.addBodyParameter("access_token", YaYawanconstants.token);
		requestParams.addBodyParameter("serverid", YaYawanconstants.zone_id);
		requestParams.addBodyParameter("servername", YaYawanconstants.zone_name);
		requestParams.addBodyParameter("accountid", YaYawanconstants.role_id);
		requestParams.addBodyParameter("rolename", YaYawanconstants.role_name);
		requestParams.addBodyParameter("app_subject", YYWMain.mOrder.goods);
	...
	private void pay_run(final Activity paramActivity) {
		...
		YaYawanconstants.pay(paramActivity, orderId, serial);
