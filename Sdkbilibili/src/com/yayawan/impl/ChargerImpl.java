...
//		requestParams.addBodyParameter("total_fee", YYWMain.mOrder.money+"");
					...
					public void onSuccess(ResponseInfo<String> arg0) {
						...
						try {
							...
							if (err_code == 0) {
								...
								game_sign = data.optString("game_sign");
	...
	private void pay_run(final Activity paramActivity) {
		...
		YaYawanconstants.pay(paramActivity, orderId , game_sign);
