...
public class ChargerImpl implements YYWCharger {
	...
	public void createOrder(final Activity paramActivity) {
		...
		requestParams.addBodyParameter("openid", callbackactivity.uid);
		requestParams.addBodyParameter("goodsname", YYWMain.mOrder.goods);
	...
	private void pay_run(final Activity paramActivity) {
		...
		YaYawanconstants.pay(paramActivity, orderId,sign,ip);
