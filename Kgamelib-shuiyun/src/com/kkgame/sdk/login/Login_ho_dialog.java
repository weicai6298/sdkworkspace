...
//				MATCH_PARENT, 1, "新用户注册", 30, mLinearLayout, 0, 0, 0, 0);
...
//		ll_mBut.addView(bt_mPhonelogin);
		...
		rl_startregister = new RelativeLayout(mActivity);
		machineFactory.MachineView(rl_startregister, MATCH_PARENT,
				WRAP_CONTENT, 0, mRelativeLayout, 20, 15, 20, 0, 100);
		tv_startregister = new TextView(mActivity);
		machineFactory.MachineTextView(tv_startregister, WRAP_CONTENT,
				WRAP_CONTENT, 0, "新用户注册", 22, mRelativeLayout, 0, 0, 20, 0,
				RelativeLayout.ALIGN_PARENT_RIGHT);
		tv_startregister.setTextColor(Color.BLUE);

		tv_fogetpassword = new TextView(mActivity);
		machineFactory.MachineTextView(tv_fogetpassword, WRAP_CONTENT,
				WRAP_CONTENT, 0, "忘记密码?", 22, mRelativeLayout, 20, 0, 20, 0,
				RelativeLayout.ALIGN_PARENT_LEFT);
		tv_fogetpassword.setTextColor(Color.RED);
		
		
		rl_startregister.addView(tv_fogetpassword);
		rl_startregister.addView(tv_startregister);
...
//				WRAP_CONTENT, 0, mRelativeLayout, 20, 15, 20, 0, 100);
		...
		ll_content.addView(rl_startregister);
