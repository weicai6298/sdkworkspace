										...
										if (err_code == 0) {
											...
											yywUser.token = JSONUtil
													.formatToken(paramActivity,
															...
															yywUser.userName);
											// 拼接给cp的user结束
											Log.i("tag","paramUser.token = "+paramUser.token);
											Log.i("tag","paramUser.uid = "+paramUser.uid);
											Log.i("tag","paramUser.userName = "+paramUser.userName);
											Yayalog.loger("yywUser.uid："+yywUser.uid);
											Yayalog.loger("yywUser.userName："+yywUser.userName);
											Yayalog.loger("yywUser.yywtoken："+yywUser.yywtoken);
											Yayalog.loger("yywUser.token："+yywUser.token);
